...
<ActivitiesCard/>
      ...
      <header aria-label="Site Header" className="bg-white border-t-4 border-green-800">
  ...
  >
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
      ...
      <p className="mt-4 text-gray-600">
        Fundacja Futprints        </p>
        <h2 className="text-3xl font-bold sm:text-4xl">Pomagamy osobom w kryzysie</h2>

        <p className="mt-4 text-gray-600">
        Pomagamy osobom ubogim i w kryzysie bezdomności. Jako że Prezes Fundacji pochodzi z Anglii, prowadzimy również działania integracyjne dla cudzoziemców.
        </p>
...
<div className="sm:first:col-span-2 py-14 px-11 rounded-lg max-w-lg bg-gray-200">
    ...
    <div className="text-lg text-black leading-[1.8]">
        <p>See how other companies are using Reply, which use cases are there, and how it all works in practice.</p>
    </div>
    <ul className="mt-6 sm:mt-10">
        <li className="pt-2 pb-4 mb-2 last:mb-0 border-b border-black border-solid">
            <a className="flex items-center justify-between text-black hover:text-black text-lg sm:text-xl font-medium"
                href="#">
...
Noclegownie w Katowicach, posiłki, porady itp.
        ...
        <a href="#" className="bg-white hover:bg-gray-200 text-purple-600 font-bold py-2 px-4 rounded">
            Sprawdź
        </a>
    </div>
{/* </div> */}
...
<div className="relative max-w-xl mx-auto mt-20">
    <img className="h-64 w-full object-cover rounded-md" src="https://images.unsplash.com/photo-1680725779155-456faadefa26"/>
    <div className="absolute inset-0 bg-gray-700 opacity-60 rounded-md"></div>
    <div className="absolute inset-0 flex items-center justify-center">
        <h2 className="text-white text-3xl font-bold text-center">Informacje dla bezdomnych w Katowicach</h2>
    </div>
</div>
...
>
  <div className="flex items-center gap-4">
    ...
    <h3 className="text-xl font-bold sm:text-2xl">Informacje dla bezdomnych w Katowicach</h3>
  </div>
</a>
...
<article
  className="w-1/4 overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm"
>
  <img
    alt="Office"

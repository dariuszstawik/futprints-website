...
const Layout = ({ children, footer }: LayoutProps) => {
  ...
  if (footer) {
    ...
    tagline =
      lang === "en"
        ? "We invite you to the Community Center in Katowice, you can find us at 5 Kordeckiego Street."
        : "Zapraszamy do Centrum Społecznościowego w Katowicach, znajdziecie nas przy ul. Kordeckiego 5.";
  }
